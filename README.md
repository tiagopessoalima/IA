...
| 4       | 📊 Classificação                | Modelos preditivos para classificação.                               | Scikit-learn (Logistic Regression, SVM, etc.), Pandas, Modelos lineares e não lineares	 | Apostila, Colab |
| 5       | 📈 Regressão                | Modelos preditivos para regressão.                               | Scikit-learn (Linear Regression, SVR, etc.), Pandas, Técnicas de avaliação (MSE, R²)  | Apostila, Colab |
